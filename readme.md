...
3. We use [RTM-pose](https://github.com/open-mmlab/mmpose/tree/main/projects/rtmpose) for 2d keypoints detection and [Cliff](https://github.com/huawei-noah/noah-research/tree/master/CLIFF) for pose initialization. Before run fitting, 2d keypoints should be processed and set as below:
```
images
└── 20230422
    ├── S01
    ...
    └── S12
        ...
        └── MoCap_20230422_150723
            ...
            └── keypoints
                    ...
                    └── 100.npy  
```
please note: the frame idx in `keypoints/` should be consistent to those in `insole/`.
