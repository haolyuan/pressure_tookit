...
# same script as in smplify-x:
# https://github.com/vchoutas/smplify-x/blob/master/smplifyx/optimizers/optim_factory.py
...
def create_optimizer(parameters, optim_type='lbfgs',
    ...
    '''
    if optim_type == 'adam':
        return (optim.Adam(parameters, lr=lr*10, betas=(beta1, beta2),
