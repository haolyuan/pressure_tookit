...
def parse_config(argv=None):
    ...
    parser.add_argument(
        '--end_idx', default=-1, help='end frame used in tracking stage')
    parser.add_argument(
        '--shape_weights',
        default=0.01,
        type=float,
    ...
    parser.add_argument(
        ...
        default=1.0,
        type=float,
        help='The weights of the Depth')
    parser.add_argument(
        '--keypoint_weights',
        default=0.01,
        type=float,
        help='The weights of the Keypoints')
    parser.add_argument(
        '--penetrate_weights',
        default=10.,
        type=float,
        help='The weights of the penetrate')
    parser.add_argument(
        '--contact_weights',
        default=1.0,
        type=float,
        help='The weights of contact')
    parser.add_argument(
        '--limb_weights',
        default=1.0,
        type=float,
