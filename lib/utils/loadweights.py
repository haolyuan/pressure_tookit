...
def load_weights(stage):
    ...
    return create_weights_dict(depth_weight, shape_weights, keypoint_weights,
                               penetrate_weights, limb_weights, gmm_weights,
                               tfoot_weights, tpose_weights, stage)


def create_weights_dict(depth_weight, shape_weights, keypoint_weights,
                        penetrate_weights, limb_weights, gmm_weights,
                        tfoot_weights, tpose_weights, stage):
